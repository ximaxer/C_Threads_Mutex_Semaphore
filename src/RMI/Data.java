...
public class Data {
    ...
    private static String USERS_FILE = "src/files/usersObjFile";
    private static String ADMINS_FILE = "src/files/adminsObjFile";
    private static String ELECTIONS_FILE = "src/files/electionsObjFile";
    private static String TABLES_FILE = "src/files/tablesObjFile";
